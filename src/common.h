...
public:
    ...
    void generate(unsigned short  = 0);
    void toStr(char *);
...
public:
    ...
    {
        return ( (globalIP() && h.globalIP()) ||(!globalIP() && !h.globalIP()) ); 
    }
...
static const int SEGMENT_NUM = 4;   
static const int SAFE_SEGMENT = 2;
static const int SEGMENT_PKTS = 13000; 
static const int SEGMENT_DURATION = 1000000; //_1S
static const int TSPKT_LEN = 188;
#endif
